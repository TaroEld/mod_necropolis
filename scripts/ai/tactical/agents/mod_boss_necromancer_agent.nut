this.mod_boss_necromancer_agent <- this.inherit("scripts/ai/tactical/agent", {
	m = {},
	function create()
	{
		this.agent.create();
		...
		this.m.Properties.BehaviorMult[this.Const.AI.Behavior.ID.PossessUndead] = 1000
		this.m.Properties.BehaviorMult[this.Const.AI.Behavior.ID.RaiseUndead] = 1000
	}
