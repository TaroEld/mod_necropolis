this.mod_kemmlers_dagger <- this.inherit("scripts/items/weapons/named/named_weapon", {
	m = {},
	function create()
	{
		...
		this.m.Description = "A short and hardened dagger, previously owned by Kemmler.";
